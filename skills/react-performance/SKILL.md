...
## 7-8. Lower-priority rules

JavaScript micro-performance (section 7: hot-loop and allocation tips) and Advanced Patterns (section 8: `useEffectEvent`, event-handler refs, init-once, `useLatest`) live in [REFERENCE.md](REFERENCE.md). Load it when you are actively tuning a hot loop or wiring stable-ref / effect-event integration — not during routine review.
